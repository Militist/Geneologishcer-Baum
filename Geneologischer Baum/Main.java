public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new Research(gt).append(irina, Relationship.parent));
        // Ищем детей Игоря
        System.out.println("Дети Игоря");
        System.out.println(new Research(gt).append(igor, Relationship.parent));

        // Ищем мужа Ирины (Чья жена Ирина?)
        System.out.println("Муж Ирины");
        System.out.println(new Research(gt).append(irina, Relationship.vife));
